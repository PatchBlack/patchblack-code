...
async function init() {
  ...
  if (window.innerWidth < 480) camera.position.set(0.5, 0.5, -8);
  else if (window.innerWidth < 768) camera.position.set(0.5, 0.5, -7);
  else if (window.innerWidth < 1024) camera.position.set(0.5, 0.5, -6);
  else camera.position.set(0.5, 0.5, -5);

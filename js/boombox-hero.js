...
(function() {
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initBoombox);
  } else {
    initBoombox();
  }
  ...
  function initBoombox() {
    ...
    // Dynamic import for Three.js modules
    import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/build/three.module.js')
      .then((THREE) => {
        window.THREE = THREE;
        return Promise.all([
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/loaders/GLTFLoader.js'),
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/loaders/RGBELoader.js'),
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/postprocessing/EffectComposer.js'),
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/postprocessing/RenderPass.js'),
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/postprocessing/ShaderPass.js'),
          import('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/three/examples/jsm/postprocessing/OutputPass.js')
        ]);
      })
      .then(([GLTFModule, RGBEModule, ComposerModule, RenderPassModule, ShaderPassModule, OutputPassModule]) => {
        const THREE = window.THREE;
        const GLTFLoader = GLTFModule.GLTFLoader;
        const RGBELoader = RGBEModule.RGBELoader;
        const EffectComposer = ComposerModule.EffectComposer;
        const RenderPass = RenderPassModule.RenderPass;
        const ShaderPass = ShaderPassModule.ShaderPass;
        const OutputPass = OutputPassModule.OutputPass;

        startBoomboxExperience(THREE, GLTFLoader, RGBELoader, EffectComposer, RenderPass, ShaderPass, OutputPass);
      })
      .catch((error) => {
  ...
  function startBoomboxExperience(THREE, GLTFLoader, RGBELoader, EffectComposer, RenderPass, ShaderPass, OutputPass) {
    const container = document.getElementById('boombox-hero-container');
    ...
    rgbeLoader.load(
      'https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/assets/textures/royal_esplanade_1k.hdr',
      (texture) => {
    ...
    // ===== AUDIO SETUP =====
    const audio = new Audio('https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/assets/audio/Boombox-audio.mp3');
    let isPlaying = false;
    ...
    loader.load(
      'https://raw.githubusercontent.com/PatchBlack/patchblack-code/main/assets/models/Boombox-01.glb',
      (gltf) => {
        boombox = gltf.scene;
    ...
    window.addEventListener('DOMContentLoaded', () => {
      if (isTouchDevice()) {
        ...
        if (!mobileButton || !cursorText) return;
